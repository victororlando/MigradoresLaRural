 ...
 * @author victoro
 */
public class MigradorRiesgosTecnicos1401_1402_1403_1404_1405 {
    ...
    public static void main(String[] args) {
        ...
        short secc[] = {1401, 1402, 1403, 1404, 1405};
...
//                    lru.setLrubicacioncantemp(0);
                        ...
                        if (pol.getPolsdemiPK().getSecc() == 1401 || pol.getPolsdemiPK().getSecc() == 1404) {
                            lru.setLrubicacionhasta(" ");
                            lru.setLrubicaciondesde(" ");
                        } else if (pol.getPolsdemiPK().getSecc() == 1402 || pol.getPolsdemiPK().getSecc() == 1403 || pol.getPolsdemiPK().getSecc() == 1405) {
                            lru.setLrubicaciondescripcion(entry.getKey());
                        }
