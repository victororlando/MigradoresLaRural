...
import com.py.larural.oraorigen.*;
 ...
 * @author chiq
 */
public class AbstractManagerOrigenProd<T> {

    private final Class<T> entityClass;
    protected final String persitenceUnitName;
    @PersistenceContext(unitName = "LRGXPROD")
    protected EntityManager em;


    public AbstractManagerOrigenProd(Class<T> entityClass, String persitenceUnitName) {
