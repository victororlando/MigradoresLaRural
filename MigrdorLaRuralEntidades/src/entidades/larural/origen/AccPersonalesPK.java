 ...
 */
@Embeddable
public class AccPersonalesPK implements Serializable {
    ...
    public AccPersonalesPK() {
    }

    public AccPersonalesPK(short tipoSeguro, short tipoOperacion, short ejercicio, short secc, int polnro, short anexo, int item) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AccPersonalesPK)) {
            return false;
        }
        AccPersonalesPK other = (AccPersonalesPK) object;
    ...
    public String toString() {
        return "entidades.larural.origen.AccPersonalesPK[ tipoSeguro=" + tipoSeguro + ", tipoOperacion=" + tipoOperacion + ", ejercicio=" + ejercicio + ", secc=" + secc + ", polnro=" + polnro + ", anexo=" + anexo + ", item=" + item + " ]";
    }
