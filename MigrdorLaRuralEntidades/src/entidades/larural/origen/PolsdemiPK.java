 ...
 */
@Embeddable
public class PolsdemiPK implements Serializable {
    ...
    public PolsdemiPK(short tipoSeguro, short tipoOperacion, short ejercicio, short secc, int polnro, short anexo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PolsdemiPK)) {
            return false;
        }
        PolsdemiPK other = (PolsdemiPK) object;
    ...
    public String toString() {
        return "entidades.larural.origen.PolsdemiPK[ tipoSeguro=" + tipoSeguro + ", tipoOperacion=" + tipoOperacion + ", ejercicio=" + ejercicio + ", secc=" + secc + ", polnro=" + polnro + ", anexo=" + anexo + " ]";
    }
