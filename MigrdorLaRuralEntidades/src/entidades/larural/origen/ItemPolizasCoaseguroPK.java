 ...
 */
@Embeddable
public class ItemPolizasCoaseguroPK implements Serializable {
    ...
    public ItemPolizasCoaseguroPK() {
    }

    public ItemPolizasCoaseguroPK(short ejercicio, short tipoOperacion, short tipoSeguro, short secc, int polnro, short anexo, int item) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ItemPolizasCoaseguroPK)) {
            return false;
        }
        ItemPolizasCoaseguroPK other = (ItemPolizasCoaseguroPK) object;
    ...
    public String toString() {
        return "entidades.larural.origen.ItemPolizasCoaseguroPK[ ejercicio=" + ejercicio + ", tipoOperacion=" + tipoOperacion + ", tipoSeguro=" + tipoSeguro + ", secc=" + secc + ", polnro=" + polnro + ", anexo=" + anexo + ", item=" + item + " ]";
    }
