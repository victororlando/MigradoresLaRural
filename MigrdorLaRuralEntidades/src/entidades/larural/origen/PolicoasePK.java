 ...
 */
@Embeddable
public class PolicoasePK implements Serializable {
    ...
    public PolicoasePK(short ejercicio, short tipoSeguro, short tipoOperacion, short secc, int polnro, short anexo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PolicoasePK)) {
            return false;
        }
        PolicoasePK other = (PolicoasePK) object;
    ...
    public String toString() {
        return "entidades.larural.origen.PolicoasePK[ ejercicio=" + ejercicio + ", tipoSeguro=" + tipoSeguro + ", tipoOperacion=" + tipoOperacion + ", secc=" + secc + ", polnro=" + polnro + ", anexo=" + anexo + " ]";
    }
