 ...
 */
@Embeddable
public class ItemDePolizasMePK implements Serializable {
    ...
    public ItemDePolizasMePK() {
    }

    public ItemDePolizasMePK(short ejercicio, short secc, int polnro, short anexo, short tipoOperacion, short tipoSeguro, int item) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ItemDePolizasMePK)) {
            return false;
        }
        ItemDePolizasMePK other = (ItemDePolizasMePK) object;
    ...
    public String toString() {
        return "entidades.larural.origen.ItemDePolizasMePK[ ejercicio=" + ejercicio + ", secc=" + secc + ", polnro=" + polnro + ", anexo=" + anexo + ", tipoOperacion=" + tipoOperacion + ", tipoSeguro=" + tipoSeguro + ", item=" + item + " ]";
    }
