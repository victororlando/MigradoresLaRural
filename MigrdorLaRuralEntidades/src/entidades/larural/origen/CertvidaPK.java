 ...
 */
@Embeddable
public class CertvidaPK implements Serializable {
    ...
    public CertvidaPK(short ejercicio, short tipoSeguro, short tipoOperacion, short secc, int polnro, short anexo, int nroCert) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CertvidaPK)) {
            return false;
        }
        CertvidaPK other = (CertvidaPK) object;
    ...
    public String toString() {
        return "entidades.larural.origen.CertvidaPK[ ejercicio=" + ejercicio + ", tipoSeguro=" + tipoSeguro + ", tipoOperacion=" + tipoOperacion + ", secc=" + secc + ", polnro=" + polnro + ", anexo=" + anexo + ", nroCert=" + nroCert + " ]";
    }
